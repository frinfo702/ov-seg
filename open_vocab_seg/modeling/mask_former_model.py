...
class MaskFormer(nn.Module):
        ...
        if self.training:
            ...
            for k in list(losses.keys()):
                if k in self.criterion.weight_dict:
                    losses[k] *= self.criterion.weight_dict[k]  # pyright: ignore[reportIndexIssue]
                else:
            ...
            for mask_cls_result, mask_pred_result, input_per_image, image_size in zip(
                ...
                if self.panoptic_on:
                    panoptic_r = self.panoptic_inference(  # pyright: ignore[reportCallIssue]
    ...
    def prepare_targets(self, targets: list[Any], images: ImageList) -> list[dict[str, Any]]:
